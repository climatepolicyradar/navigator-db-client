...
def downgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["document.id"],
            name="fk_document_instrument__document_id__document",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["instrument_id"],
            ["instrument.id"],
            name="fk_document_instrument__instrument_id__instrument",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["document.id"],
            name="fk_document_keyword__document_id__document",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["keyword_id"],
            ["keyword.id"],
            name="fk_document_keyword__keyword_id__keyword",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["document.id"],
            name="fk_document_response__document_id__document",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["response_id"],
            ["response.id"],
            name="fk_document_response__response_id__response",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["document.id"],
            name="fk_document_framework__document_id__document",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["framework_id"],
            ["framework.id"],
            name="fk_document_framework__framework_id__framework",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "expiry_ts", postgresql.TIMESTAMP(), autoincrement=False, nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["user.id"], name="fk_password_reset_token__user_id__user"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_id"],
            ["instrument.id"],
            name="fk_instrument__parent_id__instrument",
        ),
        sa.ForeignKeyConstraint(
            ["source_id"], ["source.id"], name="fk_instrument__source_id__source"
        ),
        sa.PrimaryKeyConstraint("id", name="pk_instrument"),
        sa.UniqueConstraint(
            "name", "source_id", "parent_id", name="uq_instrument__name"
        ),
    )
    op.create_table(
        "hazard",
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('hazard_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        sa.Column("name", sa.TEXT(), autoincrement=False, nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["document.id"],
            name="fk_document_language__document_id__document",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["language_id"],
            ["language.id"],
            name="fk_document_language__language_id__language",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["document.id"],
            name="fk_event__document_id__document",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["document.id"],
            name="fk_document_relationship__document_id__document",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["relationship_id"],
            ["relationship.id"],
            name="fk_document_relationship__relationship_id__relationship",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint(
            "document_id", "relationship_id", name="pk_document_relationship"
        ),
    )
    op.create_table(
        "document_hazard",
        ...
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["document.id"],
            name="fk_document_hazard__document_id__document",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["hazard_id"], ["hazard.id"], name="fk_document_hazard__hazard_id__hazard"
        ),
    ...
    op.create_table(
        ...
        sa.Column("source_id", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.ForeignKeyConstraint(
            ["parent_id"], ["sector.id"], name="fk_sector__parent_id__sector"
        ),
        sa.ForeignKeyConstraint(
            ["source_id"], ["source.id"], name="fk_sector__source_id__source"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["document.id"],
            name="fk_document_sector__document_id__document",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["sector_id"], ["sector.id"], name="fk_document_sector__sector_id__sector"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["language_id"], ["language.id"], name="fk_passage__language_id__language"
        ),
        sa.ForeignKeyConstraint(
            ["parent_passage_id"],
            ["passage.id"],
            name="fk_passage__parent_passage_id__passage",
        ),
        sa.ForeignKeyConstraint(
            ["passage_type_id"],
            ["passage_type.id"],
            name="fk_passage__passage_type_id__passage_type",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('document_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["category_id"], ["category.id"], name="fk_document__category_id__category"
        ),
        sa.ForeignKeyConstraint(
            ["geography_id"],
            ["geography.id"],
            name="fk_document__geography_id__geography",
        ),
        sa.ForeignKeyConstraint(
            ["source_id"], ["source.id"], name="fk_document__source_id__source"
        ),
        sa.ForeignKeyConstraint(
            ["type_id"],
            ["document_type.id"],
            name="fk_document__type_id__document_type",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('document_type_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        sa.Column("name", sa.TEXT(), autoincrement=False, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
        sa.Column(
            "document_id_from", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["document_id_from"],
            ["document.id"],
            name="fk_association__document_id_from__document",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["document_id_to"],
            ["document.id"],
            name="fk_association__document_id_to__document",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "affiliation_organisation", sa.VARCHAR(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "affiliation_type",
