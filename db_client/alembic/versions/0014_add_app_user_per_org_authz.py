...
def downgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["admin_id"], ["admin.id"], name="fk_admin_organisation__admin_id__admin"
        ),
        sa.ForeignKeyConstraint(
            ["organisation_id"],
            ["organisation.id"],
            name="fk_admin_organisation__organisation_id__organisation",
        ),
        sa.PrimaryKeyConstraint(
            "admin_id", "organisation_id", name="pk_admin_organisation"
        ),
    )
    op.create_table(
        "admin",
