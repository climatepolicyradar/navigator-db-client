...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["admin_id"],
            ["admin.id"],
            name=op.f("fk_admin_organisation__admin_id__admin"),
        ),
        sa.ForeignKeyConstraint(
            ["organisation_id"],
            ["organisation.id"],
            name=op.f("fk_admin_organisation__organisation_id__organisation"),
        ),
        sa.PrimaryKeyConstraint(
            "admin_id", "organisation_id", name=op.f("pk_admin_organisation")
        ),
    )
    op.drop_column("physical_document_language", "id")
    # ### end Alembic commands ###
    execute(
        "alter table physical_document_language ADD CONSTRAINT pk_physical_document_language PRIMARY KEY (language_id, document_id)"
    )
