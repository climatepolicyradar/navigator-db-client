...
TAXONOMY_DATA = [
    {
        "key": "topic",
        "filename": f"{get_library_path()}/alembic/versions/data/0031/topic_data.json",
        "file_key_path": "name",
        "allow_blanks": True,
    },
    {
        "key": "sector",
        "filename": f"{get_library_path()}/alembic/versions/data/0031/sector_data.json",
        "file_key_path": "node.name",
        "allow_blanks": True,
    },
    {
        "key": "keyword",
        "filename": f"{get_library_path()}/alembic/versions/data/0031/keyword_data.json",
        "file_key_path": "name",
        "allow_blanks": True,
    },
    {
        "key": "instrument",
        "filename": f"{get_library_path()}/alembic/versions/data/0031/instrument_data.json",
        "file_key_path": "node.name",
        "allow_blanks": True,
    },
    {
        "key": "hazard",
        "filename": f"{get_library_path()}/alembic/versions/data/0031/hazard_data.json",
        "file_key_path": "name",
        "allow_blanks": True,
    },
    {
        "key": "framework",
        "filename": f"{get_library_path()}/alembic/versions/data/0031/framework_data.json",
        "file_key_path": "name",
        "allow_blanks": True,
    },
]
