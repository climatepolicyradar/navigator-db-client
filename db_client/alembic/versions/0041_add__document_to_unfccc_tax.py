"""Add _document and _document role to UNFCCC taxonomy.

Revision ID: 0041
Revises: 0040
Create Date: 2024-07-02 14:24:00.140151
...
TAXONOMY_DATA = [
    ...
    {
        "key": "event_type",
        "filename": f"{get_library_path()}/alembic/versions/data/0041/event_type_data.json",
        "file_key_path": "name",
        "allow_blanks": True,
    },
    {
        ...
        "taxonomy": {
            "key": "role",
            "filename": f"{get_library_path()}/alembic/versions/data/0041/document_role_data.json",
            "file_key_path": "name",
            "allow_blanks": False,
        },
    },
