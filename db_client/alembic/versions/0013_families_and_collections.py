...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "family_category",
            sa.Enum("EXECUTIVE", "LEGISLATIVE", name="familycategory"),
            nullable=False,
        ),
        sa.Column(
            "family_status",
            sa.Enum("CREATED", "PUBLISHED", "DELETED", name="familystatus"),
            nullable=False,
        ),
        sa.ForeignKeyConstraint(
            ["geography_id"],
            ["geography.id"],
            name=op.f("fk_family__geography_id__geography"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["organisation_id"],
            ["organisation.id"],
            name=op.f("fk_metadata_organisation__organisation_id__organisation"),
        ),
        sa.ForeignKeyConstraint(
            ["taxonomy_id"],
            ["metadata_taxonomy.id"],
            name=op.f("fk_metadata_organisation__taxonomy_id__metadata_taxonomy"),
        ),
        sa.PrimaryKeyConstraint(
            "organisation_id", name=op.f("pk_metadata_organisation")
        ),
    )
    op.create_table(
        "collection_family",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["document_type"],
            ["family_document_type.name"],
            name=op.f("fk_family_document__document_type__family_document_type"),
        ),
        sa.ForeignKeyConstraint(
            ["document_role"],
            ["family_document_role.name"],
            name=op.f("fk_family_document__document_role__family_document_role"),
        ),
        sa.ForeignKeyConstraint(
            ["family_import_id"],
            ["family.import_id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["taxonomy_id"],
            ["metadata_taxonomy.id"],
            name=op.f("fk_family_metadata__taxonomy_id__metadata_taxonomy"),
        ),
        sa.PrimaryKeyConstraint(
            "family_import_id", "taxonomy_id", name=op.f("pk_family_metadata")
        ),
    )
    op.create_table(
        "family_organisation",
        ...
        sa.ForeignKeyConstraint(
            ["family_import_id"],
            ["family.import_id"],
            name=op.f("fk_family_organisation__family_import_id__family"),
        ),
        sa.ForeignKeyConstraint(
            ["organisation_id"],
            ["organisation.id"],
            name=op.f("fk_family_organisation__organisation_id__organisation"),
        ),
        sa.PrimaryKeyConstraint(
            "family_import_id", name=op.f("pk_family_organisation")
        ),
    )
    op.create_table(
        "family_event",
    ...
    op.add_column(
        "physical_document", sa.Column("cdn_object", sa.Text(), nullable=True)
    )
